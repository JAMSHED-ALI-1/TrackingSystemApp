  ...
  return (
    <View style={barchart_styles.barchart_main_view}>
      <View style={barchart_styles.barchart_status_box}>
        <Text style={barchart_styles.barchart_running_text}>Stopped Duration</Text>
        <View>
      ...
      <View style={barchart_styles.barchart_box}>
        <View style={[{marginLeft:-10},{transform:[{rotate: '270deg'}]}]}>
          <Text>Time</Text>
        </View>
      <BarChart
        data={data}
...
export default StoppedDurationChart;
