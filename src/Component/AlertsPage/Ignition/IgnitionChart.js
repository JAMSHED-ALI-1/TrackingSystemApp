...
import ReportBarChartButton from '../../ReportPage/ReportBarChartButton';
  ...
  return (
    <View style={barchart_styles.barchart_main_view}>
      <View style={barchart_styles.barchart_status_box}>
        <Text style={[barchart_styles.barchart_running_text,{marginLeft:20}]}>Ignition/Geo/Over speed/harsh Turn</Text>
        {/* <View>
      ...
      <View style={barchart_styles.barchart_box}>
        <View style={[{marginLeft:-15},{transform:[{rotate: '270deg'}]}]}>
          <Text>Number</Text>
        </View>
      <BarChart
        data={data}
