      ...
      <View style={[styles.trip_cont,{marginBottom:15}]}>
        ...
        <View>
          <View style={styles.heading_box}>
            <Text style={styles.alert_ingnation_text}>Geofence On/Off Report</Text>
...
{/* Geofence Entry/Exit Report */}
      <View style={styles.container}>
        <View>
          <View style={styles.heading_box}>
            <Text style={styles.alert_ingnation_text}>Geofence Entry/Exit Report</Text>
            <Text style={styles.heading_text2}>All Vehicle</Text> 
          </View>
          <BarChart
            style={styles.bar_chart_box}
