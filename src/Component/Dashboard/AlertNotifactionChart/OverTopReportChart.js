  ...
  return (
    <View >
      ...
      <View style={[styles.container,{marginBottom:15}]}>
        <View>
          <View style={styles.heading_box}>
            <Text style={styles.alert_ingnation_text}>Over Speed Report</Text>
      ...
      <View style={styles.container}>
        <View>
          <View style={styles.heading_box}>
            <Text style={styles.alert_ingnation_text}>Top Speed Report</Text>
            <Text style={styles.heading_text2}>All Vehicle</Text> 
          </View>
          <BarChart
            style={styles.bar_chart_box}
...
export default OverTopReportChart
